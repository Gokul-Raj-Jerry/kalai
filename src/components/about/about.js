                        ...
                        <div className="col-lg-6 col-md-12 col-12">
                            <div className="wpo-about-text">
                                <div className="wpo-section-title">
                                    ...
                                    <h2>A Fresh approach to enhancing new
                                        <span>
                                            Skills.
                                            <i className="shape">
                                ...
                                <p>Skill is one of the most crucial and valuable assets an individual can have. It plays a major role in developing the future of individuals, societies, and nations. The significance of skills cannot be overstated, individual development of nations.</p>
                                <p>One of the primary benefits of education is its ability to empower individuals.
                                One of the major benefits of skills is its ability to empower individuals. Through skills, individuals acquire knowledge, skills and enable them to navigate the complexities of life.</p>
                                <div className="wpo-about-features-wrap">
                                    <div className="wpo-about-features-item">
                                        ...
                                        <div className="wpo-about-features-text">
                                            <h5><CountUp end={17} enableScrollSpy />+ Courses</h5>
                                        </div>
                                    </div>
                                    <div className="wpo-about-features-item">
                                        <div className="wpo-about-features-icon">
                                        ...
                                        <div className="wpo-about-features-text">
                                            <h5><CountUp end={100} enableScrollSpy />+ Workshop</h5>
                                        </div>
                                    </div>
                                    <div className="wpo-about-features-item">
                                        <div className="wpo-about-features-icon">
                                    ...
                                    <div className="wpo-about-features-item">
                                        ...
                                        <div className="wpo-about-features-text">
                                            <h5><CountUp end={100} enableScrollSpy />+ Mentors</h5>
                                        </div>
                                    </div>
                                </div>
