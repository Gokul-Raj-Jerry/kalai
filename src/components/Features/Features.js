                            ...
                            <div className="feature-item-wrap">
                                <div className="feature-item">
                                    ...
                                    <div className="feature-text">
                                        <h2><Link onClick={ClickHandler} to="/course">17+ Skills</Link></h2>
                                        <p>We are providing best skills. That help you be expert. </p>
                                    </div>
                                </div>
                        ...
                        <div className="col col-lg-3 col-md-6 col-12">
                            <div className="feature-item-wrap active">
                                <div className="feature-item">
                                    ...
                                    <div className="feature-text">
                                        <h2><Link onClick={ClickHandler} to="/course">10k+ Students</Link></h2>
                                        <p>We are providing best skills. That help you be expert. </p>
                                    </div>
                                </div>
                                <div className="feature-item-hidden">
                        ...
                        <div className="col col-lg-3 col-md-6 col-12">
                            <div className="feature-item-wrap">
                                <div className="feature-item">
                                    ...
                                    <div className="feature-text">
                                        <h2><Link onClick={ClickHandler} to="/course">Live Workshops</Link></h2>
                                        <p>We are providing best Courses. That help you be expert.</p>
                                    </div>
                                </div>
                                <div className="feature-item-hidden">
                        ...
                        <div className="col col-lg-3 col-md-6 col-12">
                            <div className="feature-item-wrap">
                                <div className="feature-item">
                                    ...
                                    <div className="feature-text">
                                        <h2><Link onClick={ClickHandler} to="/course">100+ Mentors</Link></h2>
                                        <p>We are providing best Courses. That help you be expert. </p>
                                    </div>
                                </div>
                                <div className="feature-item-hidden">
